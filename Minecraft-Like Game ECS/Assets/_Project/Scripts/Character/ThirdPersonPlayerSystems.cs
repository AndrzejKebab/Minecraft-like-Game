...
#if ENABLE_INPUT_SYSTEM
        foreach ((RefRW<ThirdPersonPlayerInputs> playerInputs, RefRO<ThirdPersonPlayer> player) in SystemAPI.Query<RefRW<ThirdPersonPlayerInputs>, RefRO<ThirdPersonPlayer>>())
        {
...
public partial struct ThirdPersonPlayerVariableStepControlSystem : ISystem
{
    ...
    {
        foreach ((RefRO<ThirdPersonPlayerInputs> playerInputs, RefRO<ThirdPersonPlayer> player) in SystemAPI.Query<RefRO<ThirdPersonPlayerInputs>, RefRO<ThirdPersonPlayer>>().WithAll<Simulate>())
        {
